...
class frame1(CTkFrame):
    def __init__(self , master):
        ...
        def bc2(self):
            ...
            figure.add_subplot(122)
            plt.imshow(res)
            plt.title(f'resampled image with method of {method}')
            plt.axis('off')
            chart = FigureCanvasTkAgg(figure, self.root)
            chart.get_tk_widget().grid(row=0, column=0, rowspan=2, columnspan=4, pady=10, padx=100)
            return None
...
class frame3(CTkFrame):
    def __init__(self , master):
        ...
        def bc1(self):
            ...
            figure.add_subplot(122)
            plt.imshow(false)
            plt.title(f'mixed bands of {R},{G},{B}')
            plt.axis('off')
            chart = FigureCanvasTkAgg(figure, self.root)
            chart.get_tk_widget().grid(row=0, column=0, rowspan=2, columnspan=4, pady=10, padx=100)
...
class frame4(CTkFrame):
    def __init__(self , master):
        ...
        def bc2(self):
            ...
            plt.title(f'image after applying {type} kernel with size {size}')
            plt.axis('off')
            chart = FigureCanvasTkAgg(figure, self.root)
            chart.get_tk_widget().grid(row=0, column=0, rowspan=2, columnspan=4, pady=10, padx=100)
    ...
    def __init__(self , master , **kwargs):
        ...
        def bc1(self):
            ...
            if method == 'harris':
                ...
                plt.title('harris corner detection after transform')
                plt.axis('off')
                chart = FigureCanvasTkAgg(figure, self.root)
                chart.get_tk_widget().grid(row=0, column=0, rowspan=2, columnspan=4, pady=10, padx=100)
            elif method == 'moravec':
                ...
                figure.add_subplot(122)
                plt.imshow(img2)
                plt.title('moravec corner detection after transform')
                plt.axis('off')
                ...
                figure.add_subplot(122)
                plt.imshow(img2_vis)
                plt.title('shi-tomasi corner detection after transform')
                plt.axis('off')
                chart = FigureCanvasTkAgg(figure, self.root)
                chart.get_tk_widget().grid(row=0, column=0, rowspan=2, columnspan=4, pady=10, padx=100)
                ...
                plt.title('sift corner detection')
                plt.axis('off')
                figure.add_subplot(122)
                plt.imshow(img2_sift)
                plt.title('sift corner detection after transform')
                plt.axis('off')
                chart = FigureCanvasTkAgg(figure, self.root)
                chart.get_tk_widget().grid(row=0, column=0, rowspan=2, columnspan=4, pady=10, padx=100)
        ####################  widgets  ####################
        ...
        def bc5(self):
            ...
            if method == 'threshold based':
                ...
                figure.add_subplot(122)
                plt.imshow(mask)
                plt.title('segmented image using threshold based method')
                plt.axis('off')
                chart = FigureCanvasTkAgg(figure, self.root)
                chart.get_tk_widget().grid(row=0, column=0, rowspan=2, columnspan=4, pady=10, padx=100)
                ...
                plt.axis('off')
                figure.add_subplot(122)
                plt.title('segmented image using watershed method')
                plt.imshow(mask)
                plt.axis('off')
                chart = FigureCanvasTkAgg(figure, self.root)
                chart.get_tk_widget().grid(row=0, column=0, rowspan=2, columnspan=4, pady=10, padx=100)
                ...
                figure.add_subplot(122)
                plt.imshow(mask)
                plt.title('segmented image using k-means method')
                plt.axis('off')
                chart = FigureCanvasTkAgg(figure, self.root)
                chart.get_tk_widget().grid(row=0, column=0, rowspan=2, columnspan=4, pady=10, padx=100)
                ...
                figure.add_subplot(122)
                plt.imshow(mask)
                plt.title('segmented image using mean-shift method')
                plt.axis('off')
                chart = FigureCanvasTkAgg(figure, self.root)
                chart.get_tk_widget().grid(row=0, column=0, rowspan=2, columnspan=4, pady=10, padx=100)
            elif method == 'FCM':
                ...
                figure.add_subplot(122)
                plt.imshow(mask)
                plt.title('segmented image using FCM method')
                plt.axis('off')
                chart = FigureCanvasTkAgg(figure, self.root)
                chart.get_tk_widget().grid(row=0, column=0, rowspan=2, columnspan=4, pady=10, padx=100)
        ####################  widgets  ####################
